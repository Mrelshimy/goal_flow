                ...
                <div className="relative -mt-16 mb-6 flex justify-between items-end">
                    <div className="relative group">
                        ...
                        <button 
                            ...
                            className="absolute bottom-1 right-1 bg-white p-2 rounded-full shadow-md text-gray-600 hover:text-primary transition-colors border border-gray-200"
                            title="Change Photo"
                        >
                            <Camera size={18} />
                        </button>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-100 focus:border-primary outline-none"
                                />
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-2 pt-4 border-t border-gray-100">
                             ...
                             <div>
                                ...
                                <input 
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-100 focus:border-primary outline-none"
                                />
                             </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end pt-4">
                        <button 
                            type="submit" 
                            disabled={isSaving}
                            className="bg-primary text-white px-6 py-2.5 rounded-lg font-medium hover:bg-blue-600 transition-colors shadow-sm flex items-center gap-2 disabled:opacity-70"
                        >
                            <Save size={18} />
